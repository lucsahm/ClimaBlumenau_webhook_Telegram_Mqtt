...
MQTT_PORT = 1883
MQTT_TOPIC = 'seu/topico' # seu topico MQTT

TELEGRAM_BOT_TOKEN = 'BOTTOKEN' # https://api.telegram.org/bot<CHAVEDOBOT>/getUpdates para verificar qual a palavra do codigo correta
